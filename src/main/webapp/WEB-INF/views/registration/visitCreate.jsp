			...
			<form>
				<div class="col-lg-8 col-md-8">
					...
					<input type="text" name="name" placeholder="숙소명"
						onfocus="this.placeholder = ''" onblur="this.placeholder = '숙소명'"
						required="" class="single-input my-3">
					<div class="row my-3">
						<div class="col-md-4">
						...
						<div class="col-md-4">
							<input type="number" name="price" placeholder="1박 요금"
								onfocus="this.placeholder = ''"
								onblur="this.placeholder = '1박 요금'" required=""
								class="single-input">
						</div>
					</div>
					<textarea class="single-textarea h-25" rows="10"
					...
					<div>
						<input id="member_post" class="single-input mt-10 my-3"
							placeholder="Post" readonly onclick="findAddr()"> <input
							id="member_addr" class="single-input mt-10 my-3"
							placeholder="Address" readonly> <input type="text"
							class="single-input mt-10 my-3" placeholder="Detailed Address">
					</div>
					...
					<div class="col-lg-3 col-md-4">
						...
						<div class="row m-2">
							...
							&nbsp;&nbsp;&nbsp; <input type="number" name="price"
								placeholder="1박 요금" onfocus="this.placeholder = ''"
								onblur="this.placeholder = ''" required=""
								class="single-input w-50" value="4">
						</div>
						<div class="row m-2">
							<p>침대</p>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="number"
								name="price" placeholder="1박 요금" onfocus="this.placeholder = ''"
								onblur="this.placeholder = ''" required=""
								class="single-input w-50" value="1">
						</div>
						<div class="row m-2">
							<p>욕실</p>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="number"
				...
				<div class="row m-5 d-flex justify-content-center">
					<div class="col-2">
						<input type="button" class="genric-btn primary-border radius m-3"
							value="수영장"> <input type="button"
							class="genric-btn primary-border radius m-3" value="수영장">
						<input type="button" class="genric-btn primary-border radius m-3"
							value="수영장">
					</div>
					<div class="col-2">
