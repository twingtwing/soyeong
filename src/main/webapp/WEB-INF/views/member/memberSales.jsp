			...
			<div class="div-Pay pt-3">
				...
				<div class="active-div-Pay">
					<div class="row pt-2">
						...
						<div
							class="pay-date-detail col-md-12 d-print-block d-flex justify-content-center mt-3">
						...
						<table class="table text-center align-middle">
							...
							<tr>
								<td colspan="5" class="text-center"><a
									href="#collapse-PayY-1" data-toggle="collapse">더보기</a></td>
							</tr>
				...
				<div class="d-none">
					...
					<div class="row mt-4 pt-4">
						<table class="table text-center">
							...
							<tr>
								<td colspan="5" class="text-center"><a
									href="#collapse-PayN-1" data-toggle="collapse">더보기</a></td>
							</tr>
						...
						<table class="table text-center">
							...
							<tr>
								...
								<td class="d-flex justify-content-around align-middle">
									<button type="button" class="btn btn-primary refund-Y">
										<i class="far fa-circle"></i>
									</button>
									<button type="button" class="btn btn-danger refund-N">
							...
							<tr>
								<td colspan="7" class="text-center"><a
									href="#collapse-Ref-1" data-toggle="collapse">더보기</a></td>
							</tr>
						...
						<div class="book_tabel_item">
							<div class="form-group mr-3">
								<div class='input-group date' id='datetimepicker-math'>
									<input type='text' class="form-control"
										placeholder="Enger Date" /> <span class="input-group-addon">
										<i class="fa fa-calendar" aria-hidden="true"></i>
									</span>
								</div>
							</div>
