								...
								<ul>
									<li class="notification-unread"><a
										href="javascript:void()"> <img
											...
											src="resources/admin/images/avatar/1.jpg" alt="">
									...
									<li class="notification-unread"><a
										href="javascript:void()"> <img
											class="float-left mr-3 avatar-img"
											src="resources/admin/images/avatar/2.jpg" alt="">
											<div class="notification-content">
									...
									<li><a href="javascript:void()"> <img
											class="float-left mr-3 avatar-img"
											src="resources/admin/images/avatar/3.jpg" alt="">
											<div class="notification-content">
									...
									<li><a href="javascript:void()"> <img
											class="float-left mr-3 avatar-img"
											src="resources/admin/images/avatar/4.jpg" alt="">
											<div class="notification-content">
					...
					<li class="icons dropdown">
						<div class="user-img c-pointer position-relative"
							...
							<span class="activity active"></span> <img
								src="resources/admin/images/user/1.png" height="40" width="40"
								alt="">
						</div>
						<div
