				...
				<div class="col-lg-4  col-md-6 col-sm-6">
					<div class="single-footer-widget">
						...
						<p>Our company aims to feel the atmosphere of the travel
							...
							provide services that increase convenience while reducing the
							risk of hosts and individuals.</p>
					</div>
				</div>
				<div
					class="col-lg-1 col-md-3 col-sm-3 d-flex justify-content-center">
					<div class="single-footer-widget">
						<h6 class="footer_title text-center">Links</h6>
						<div class="row">
							<div class="col">
								<ul class="list_style text-center">
									<li><a href="home.do">Home</a></li>
									<li><a href="question.do">Q &amp; A</a></li>
